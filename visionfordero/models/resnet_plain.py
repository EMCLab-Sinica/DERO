...
def _resnet(
    ...
    **kwargs: Any,
    ...
    model = ResNet_Plain(block, layers, **kwargs)
...
def resnet18plain(*, weights = None, progress: bool = True, **kwargs: Any) -> ResNet_Plain:
    return _resnet(BasicBlock, [2, 2, 2, 2], weights, progress, **kwargs)


@register_model()
@handle_legacy_interface()
def resnet34plain(*, weights = None, progress: bool = True, **kwargs: Any) -> ResNet_Plain:
    return _resnet(BasicBlock, [3, 4, 6, 3], weights, progress, **kwargs)


@register_model()
@handle_legacy_interface()
def resnet50plain(*, weights = None, progress: bool = True, **kwargs: Any) -> ResNet_Plain:
    return _resnet(Bottleneck, [3, 4, 6, 3], weights, progress, **kwargs)


@register_model()
@handle_legacy_interface()
def resnet101plain(*, weights = None, progress: bool = True, **kwargs: Any) -> ResNet_Plain:
    return _resnet(Bottleneck, [3, 4, 23, 3], weights, progress, **kwargs)


@register_model()
@handle_legacy_interface()
def resnet152plain(*, weights = None, progress: bool = True, **kwargs: Any) -> ResNet_Plain:
