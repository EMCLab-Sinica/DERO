...
class SRConv(nn.Module):
    def __init__(self, in_planes, planes, kernel_size=3,
        ...
        self.conv = nn.Conv2d(in_planes, planes, kernel_size=kernel_size,stride=stride, groups= groups, padding=self.padding )
...
def mcunet_rep_v1(
    *, weights = None, progress: bool = True, **kwargs: Any
    ...
    # McuNet_rep-10fps_imagenet.json
    init_ch = 24
    last_channel= 192
    ...
    resolution =48
    model = McuNet_rep(init_ch = init_ch, last_channel=last_channel, inverted_residual_setting=inverted_residual_setting, **kwargs)
    return model
...
# McuNet_rep-256kb-1mb_imagenet.json
    init_ch = 16
    last_channel= 160
    inverted_residual_setting= [
        [1, 8, 1, 1, 3],
...
# McuNet_rep-320kb-1mb_imagenet.json
    init_ch = 16
    last_channel= 160
    inverted_residual_setting= [
        [1, 8, 1, 1, 3],
...
# McuNet_rep-512kb-2mb_imagenet.json
    init_ch = 32
    last_channel= 320
    inverted_residual_setting= [
        [1, 16, 1, 1, 3],
