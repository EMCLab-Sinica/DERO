...
def _resnet(
    ...
    **kwargs: Any,
    ...
    model = ResNet_rep(block, layers, **kwargs)
...
def resnet18rep(*, weights = None, progress: bool = True, **kwargs: Any) -> ResNet_rep:
    return _resnet(BasicBlock, [2, 2, 2, 2], weights, progress, **kwargs)


@register_model()
@handle_legacy_interface()
def resnet34rep(*, weights = None, progress: bool = True, **kwargs: Any) -> ResNet_rep:
    return _resnet(BasicBlock, [3, 4, 6, 3], weights, progress, **kwargs)


@register_model()
@handle_legacy_interface()
def resnet50rep(*, weights = None, progress: bool = True, **kwargs: Any) -> ResNet_rep:
    return _resnet(Bottleneck, [3, 4, 6, 3], weights, progress, **kwargs)


@register_model()
@handle_legacy_interface()
def resnet101rep(*, weights = None, progress: bool = True, **kwargs: Any) -> ResNet_rep:
    return _resnet(Bottleneck, [3, 4, 23, 3], weights, progress, **kwargs)


@register_model()
@handle_legacy_interface()
def resnet152rep(*, weights = None, progress: bool = True, **kwargs: Any) -> ResNet_rep:
