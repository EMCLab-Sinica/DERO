...
class DenseNet_plain(nn.Module):
...
def _densenet(
    ...
    **kwargs: Any,
    ...
    model = DenseNet_plain(growth_rate, block_config, num_init_features, **kwargs)
...
def densenet121_plain(*, weights: Optional[DenseNet121_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet_plain:
...
def densenet161_plain(*, weights: Optional[DenseNet161_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet_plain:
...
def densenet169_plain(*, weights: Optional[DenseNet169_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet_plain:
...
def densenet201_plain(*, weights: Optional[DenseNet201_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet_plain:
