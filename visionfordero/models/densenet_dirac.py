...
class _DenseLayer(nn.Module):
    def __init__(
        ...
        self.conv1 = DiracConv2d(num_input_features, bn_size * growth_rate, kernel_size=1, stride=1, bias=False)

        self.norm2 = nn.BatchNorm2d(bn_size * growth_rate)
        self.relu2 = nn.ReLU(inplace=True)
        self.conv2 = DiracConv2d(bn_size * growth_rate, growth_rate, kernel_size=3, stride=1, padding=1, bias=False)
...
class _Transition(nn.Sequential):
    def __init__(self, num_input_features: int, num_output_features: int) -> None:
        ...
        self.conv = DiracConv2d(num_input_features, num_output_features, kernel_size=1, stride=1, bias=False)
        self.pool = nn.AvgPool2d(kernel_size=2, stride=2)


class DenseNet_dirac(nn.Module):
    ...
    def __init__(
        ...
        self.features = nn.Sequential(
            OrderedDict(
                [
                    ("conv0", DiracConv2d(3, num_init_features, kernel_size=7, stride=2, padding=3, bias=False)),
...
def _densenet(
    ...
    **kwargs: Any,
    ...
    model = DenseNet_dirac(growth_rate, block_config, num_init_features, **kwargs)
...
def densenet121_dirac(*, weights: Optional[DenseNet121_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet_dirac:
...
def densenet161_dirac(*, weights: Optional[DenseNet161_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet_dirac:
...
def densenet169_dirac(*, weights: Optional[DenseNet169_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet_dirac:
...
def densenet201_dirac(*, weights: Optional[DenseNet201_Weights] = None, progress: bool = True, **kwargs: Any) -> DenseNet_dirac:
