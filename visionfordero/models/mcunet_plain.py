...
def mcunet_plain_v1(
    *, weights = None, progress: bool = True, **kwargs: Any
    ...
    # McuNet_plain-10fps_imagenet.json
    init_ch = 24
    last_channel= 192
    ...
    resolution =48
    model = McuNet_plain(init_ch = init_ch, last_channel=last_channel, inverted_residual_setting=inverted_residual_setting, **kwargs)
    return model
...
# McuNet_plain-5fps_imagenet.json
    init_ch = 16
    last_channel= 160
    inverted_residual_setting= [
        [1, 8, 1, 1, 3],
...
# McuNet_plain-256kb-1mb_imagenet.json
    init_ch = 16
    last_channel= 160
    inverted_residual_setting= [
        [1, 8, 1, 1, 3],
...
# McuNet_plain-320kb-1mb_imagenet.json
    init_ch = 16
    last_channel= 160
    inverted_residual_setting= [
        [1, 8, 1, 1, 3],
...
# McuNet_plain-512kb-2mb_imagenet.json
    init_ch = 32
    last_channel= 320
    inverted_residual_setting= [
        [1, 16, 1, 1, 3],
